...
namespace UnitTests.SenderMocks
{
    class TelegramBotClientMock:ITelegramBotClient
    {
        public List<Message> BotMessages { get; }
        public ReplyKeyboardMarkup ReplyKeyboardMarkup { get; private set; }

        public TelegramBotClientMock()
        {
            BotMessages = new List<Message>();
        }
        ...
        {
            return SendTextMessageAsync(chatId, "", replyMarkup: replyMarkup);
        }
        ...
        {
            return SendTextMessageAsync(chatId, text);
        }
        ...
        {
            var message = new Message() { MessageId = 1111 , Text = text};
            if(replyMarkup is ReplyKeyboardMarkup)
            {
                ReplyKeyboardMarkup = (ReplyKeyboardMarkup)replyMarkup;
            }
